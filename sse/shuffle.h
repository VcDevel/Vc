...
namespace Vc
{
    ...
    namespace Mem
    {
        ...
        template<VecPos Dst0, VecPos Dst1> __m128d ALWAYS_INLINE CONST shuffle(__m128d x, __m128d y) {
        ...
        template<VecPos Dst0, VecPos Dst1> __m128d ALWAYS_INLINE CONST blend(__m128d x, __m128d y) {
        ...
        template<VecPos Dst0, VecPos Dst1, VecPos Dst2, VecPos Dst3> __m128i ALWAYS_INLINE CONST permuteHi(__m128i x) {
