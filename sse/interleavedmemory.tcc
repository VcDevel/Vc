...
template<> struct InterleaveImpl<SSE::sfloat_v, 8> {
    ...
    template<typename I> static inline void deinterleave(float const *const data,/*{{{*/
            const I &i, sfloat_v &v0, sfloat_v &v1)
    {
        const __m128 i0a = _mm_castpd_ps(_mm_load_sd(reinterpret_cast<const double *>(&data[i[0]])));
        const __m128 i1a = _mm_castpd_ps(_mm_load_sd(reinterpret_cast<const double *>(&data[i[1]])));
        const __m128 i2a = _mm_castpd_ps(_mm_load_sd(reinterpret_cast<const double *>(&data[i[2]])));
        const __m128 i3a = _mm_castpd_ps(_mm_load_sd(reinterpret_cast<const double *>(&data[i[3]])));
        const __m128 i4a = _mm_castpd_ps(_mm_load_sd(reinterpret_cast<const double *>(&data[i[4]])));
        const __m128 i5a = _mm_castpd_ps(_mm_load_sd(reinterpret_cast<const double *>(&data[i[5]])));
        const __m128 i6a = _mm_castpd_ps(_mm_load_sd(reinterpret_cast<const double *>(&data[i[6]])));
        const __m128 i7a = _mm_castpd_ps(_mm_load_sd(reinterpret_cast<const double *>(&data[i[7]])));
    ...
    template<typename I> static inline void deinterleave(float const *const data,/*{{{*/
            const I &i, sfloat_v &v0, sfloat_v &v1, sfloat_v &v2)
    {
        const __m128 i0a = _mm_loadu_ps(&data[i[0]]);
        const __m128 i1a = _mm_loadu_ps(&data[i[1]]);
        const __m128 i2a = _mm_loadu_ps(&data[i[2]]);
        const __m128 i3a = _mm_loadu_ps(&data[i[3]]);
        const __m128 i4a = _mm_loadu_ps(&data[i[4]]);
        const __m128 i5a = _mm_loadu_ps(&data[i[5]]);
        const __m128 i6a = _mm_loadu_ps(&data[i[6]]);
        const __m128 i7a = _mm_loadu_ps(&data[i[7]]);
    ...
    template<typename I> static inline void deinterleave(float const *const data,/*{{{*/
            const I &i, sfloat_v &v0, sfloat_v &v1, sfloat_v &v2, sfloat_v &v3)
    {
        const __m128 i0a = _mm_loadu_ps(&data[i[0]]);
        const __m128 i1a = _mm_loadu_ps(&data[i[1]]);
        const __m128 i2a = _mm_loadu_ps(&data[i[2]]);
    ...
    template<typename I> static inline void deinterleave(float const *const data,/*{{{*/
            const I &i, sfloat_v &v0, sfloat_v &v1, sfloat_v &v2, sfloat_v &v3, sfloat_v &v4)
    {
        const __m128 i0a = _mm_loadu_ps(&data[i[0]]);
        const __m128 i1a = _mm_loadu_ps(&data[i[1]]);
        const __m128 i2a = _mm_loadu_ps(&data[i[2]]);
    ...
    template<typename I> static inline void deinterleave(float const *const data,/*{{{*/
            const I &i, sfloat_v &v0, sfloat_v &v1, sfloat_v &v2, sfloat_v &v3, sfloat_v &v4, sfloat_v &v5)
    {
        const __m128 i0a = _mm_loadu_ps(&data[i[0]]);
        const __m128 i1a = _mm_loadu_ps(&data[i[1]]);
        const __m128 i2a = _mm_loadu_ps(&data[i[2]]);
        ...
        const __m128 i6a = _mm_loadu_ps(&data[i[6]]);
        const __m128 i7a = _mm_loadu_ps(&data[i[7]]);
        const __m128 i0b = _mm_castpd_ps(_mm_load_sd(reinterpret_cast<const double *>(&data[i[0] + float_v::Size])));
        const __m128 i1b = _mm_castpd_ps(_mm_load_sd(reinterpret_cast<const double *>(&data[i[1] + float_v::Size])));
        const __m128 i2b = _mm_castpd_ps(_mm_load_sd(reinterpret_cast<const double *>(&data[i[2] + float_v::Size])));
        const __m128 i3b = _mm_castpd_ps(_mm_load_sd(reinterpret_cast<const double *>(&data[i[3] + float_v::Size])));
        const __m128 i4b = _mm_castpd_ps(_mm_load_sd(reinterpret_cast<const double *>(&data[i[4] + float_v::Size])));
        const __m128 i5b = _mm_castpd_ps(_mm_load_sd(reinterpret_cast<const double *>(&data[i[5] + float_v::Size])));
        const __m128 i6b = _mm_castpd_ps(_mm_load_sd(reinterpret_cast<const double *>(&data[i[6] + float_v::Size])));
        const __m128 i7b = _mm_castpd_ps(_mm_load_sd(reinterpret_cast<const double *>(&data[i[7] + float_v::Size])));
    ...
    template<typename I> static inline void deinterleave(float const *const data,/*{{{*/
            const I &i, sfloat_v &v0, sfloat_v &v1, sfloat_v &v2, sfloat_v &v3, sfloat_v &v4, sfloat_v &v5, sfloat_v &v6)
    {
        const __m128 i0a = _mm_loadu_ps(&data[i[0]]);
        const __m128 i0b = _mm_loadu_ps(&data[i[0] + float_v::Size]);
        const __m128 i1a = _mm_loadu_ps(&data[i[1]]);
        const __m128 i1b = _mm_loadu_ps(&data[i[1] + float_v::Size]);
        const __m128 i2a = _mm_loadu_ps(&data[i[2]]);
        const __m128 i2b = _mm_loadu_ps(&data[i[2] + float_v::Size]);
        const __m128 i3a = _mm_loadu_ps(&data[i[3]]);
        const __m128 i3b = _mm_loadu_ps(&data[i[3] + float_v::Size]);
        const __m128 i4a = _mm_loadu_ps(&data[i[4]]);
        const __m128 i4b = _mm_loadu_ps(&data[i[4] + float_v::Size]);
        const __m128 i5a = _mm_loadu_ps(&data[i[5]]);
        const __m128 i5b = _mm_loadu_ps(&data[i[5] + float_v::Size]);
        const __m128 i6a = _mm_loadu_ps(&data[i[6]]);
        const __m128 i6b = _mm_loadu_ps(&data[i[6] + float_v::Size]);
        const __m128 i7a = _mm_loadu_ps(&data[i[7]]);
        const __m128 i7b = _mm_loadu_ps(&data[i[7] + float_v::Size]);
    ...
    template<typename I> static inline void deinterleave(float const *const data,/*{{{*/
            const I &i, sfloat_v &v0, sfloat_v &v1, sfloat_v &v2, sfloat_v &v3, sfloat_v &v4, sfloat_v &v5, sfloat_v &v6, sfloat_v &v7)
    {
        const __m128 i0a = _mm_loadu_ps(&data[i[0]]);
        const __m128 i0b = _mm_loadu_ps(&data[i[0] + float_v::Size]);
        const __m128 i1a = _mm_loadu_ps(&data[i[1]]);
