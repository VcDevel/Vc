 ...
 * \tparam T The type of the allocated memory. Beware, that the constructor is not called.
 ...
 * \warning The constructor of T is not called.
 *
 * \see Vc::free
 *
 * \ingroup Utilities
 ...
 *
 * \warning The destructor of T is not called.
 *
 * \ingroup Utilities
 * \headerfile memory.h <Vc/Memory>
 */
