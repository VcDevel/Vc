...
namespace SSE
{
    ...
    template<> V_ALIGN(64) const unsigned long long c_log<double, Vc::SSE::Mask<2> >::_dataI[30] = {
        0x000003ff000003ffull, 0x000003ff000003ffull, // bias
        0x7ff0000000000000ull, 0x7ff0000000000000ull, // exponentMask (+inf)

        0x3f1ab4c293c31bb0ull, 0x3f1ab4c293c31bb0ull, // P[0]
        0x3fdfd6f53f5652f2ull, 0x3fdfd6f53f5652f2ull, // P[1]
        0x4012d2baed926911ull, 0x4012d2baed926911ull, // P[2]
        0x402cff72c63eeb2eull, 0x402cff72c63eeb2eull, // P[3]
        0x4031efd6924bc84dull, 0x4031efd6924bc84dull, // P[4]
        0x401ed5637d7edcf8ull, 0x401ed5637d7edcf8ull, // P[5]

        0x40269320ae97ef8eull, 0x40269320ae97ef8eull, // Q[0]
        0x40469d2c4e19c033ull, 0x40469d2c4e19c033ull, // Q[1]
        0x4054bf33a326bdbdull, 0x4054bf33a326bdbdull, // Q[2]
        0x4051c9e2eb5eae21ull, 0x4051c9e2eb5eae21ull, // Q[3]
        0x4037200a9e1f25b2ull, 0x4037200a9e1f25b2ull, // Q[4]

        0xfff0000000000000ull, 0xfff0000000000000ull, // -inf
        0x0010000000000000ull, 0x0010000000000000ull  // min()
    };
    template<> V_ALIGN(16) const double c_log<double, Vc::SSE::Mask<2> >::_dataT[12] = {
        // 1/sqrt(2)
        0.70710678118654757273731092936941422522068023681640625, 0.70710678118654757273731092936941422522068023681640625,
        // ln(2) - 0.693359375
        -0.0002121944400546905827678785418234319244999, -0.0002121944400546905827678785418234319244999,
        // ln(2) + 0.0002121944400546905827678785418234319244999
        0.693359375, 0.693359375,
        0.5, 0.5,
        // log10(e)
        0.434294481903251827651128918916605082294397005803666566114454, 0.434294481903251827651128918916605082294397005803666566114454,
        // log2(e)
        1.44269504088896340735992468100189213742664595415298593413545, 1.44269504088896340735992468100189213742664595415298593413545
    };

    template<> V_ALIGN(64) const unsigned int c_log<float, Vc::SSE::Mask<4> >::_dataI[60] = {
        0x0000007fu, 0x0000007fu, 0x0000007fu, 0x0000007fu, // bias
    ...
    template<> V_ALIGN(16) const float c_log<float, Vc::SSE::Mask<4> >::_dataT[24] = {
        0.70710678118654757273731092936941422522068023681640625f, // 1/sqrt(2)
        0.70710678118654757273731092936941422522068023681640625f, // 1/sqrt(2)
        0.70710678118654757273731092936941422522068023681640625f, // 1/sqrt(2)
        0.70710678118654757273731092936941422522068023681640625f, // 1/sqrt(2)
