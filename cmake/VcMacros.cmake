...
macro(vc_set_preferred_compiler_flags)
   ...
   elseif(Vc_COMPILER_IS_GCC)
      ...
      if(NOT GCC_4_4_6)
         ...
         if(NOT GCC_4_4_1)
            UserWarning("Your GCC is older than 4.4.1. This is known to cause problems/bugs. Please update to the latest GCC if you can.")
            macro_ensure_version("4.3.0" "${Vc_GCC_VERSION}" GCC_4_3_0)
            if(NOT GCC_4_3_0)
               UserWarning("Your GCC is older than 4.3.0. It is unable to handle all SSE2 intrinsics. All SSE code will be disabled. Please update to the latest GCC if you can.")
