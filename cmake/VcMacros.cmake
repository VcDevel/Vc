   ...
   if(${_disabled_index} EQUAL -1 AND (NOT _only_targets OR ${_only_index} GREATER -1))
      ...
      foreach(_flag ${ARGN})
         ...
         foreach(_flag ${_flag_list})
            message(STATUS "at ${_impl}, testing ${_flag}")
...
macro(vc_compile_for_all_implementations _objs _src)
   ...
   if(NOT Vc_AVX_INTRINSICS_BROKEN)
      ...
      if(NOT Vc_FMA4_INTRINSICS_BROKEN)
         _vc_compile_one_implementation(${_objs} SSE+FMA4 "-mfma4"         ""    "")
         _vc_compile_one_implementation(${_objs} AVX+FMA4 "-mavx -mfma4"   ""    "")
      endif()
      if(NOT Vc_XOP_INTRINSICS_BROKEN)
         _vc_compile_one_implementation(${_objs} SSE+XOP "-mxop"         ""    "")
         _vc_compile_one_implementation(${_objs} AVX+XOP "-mavx -mxop"   ""    "")
         if(NOT Vc_FMA4_INTRINSICS_BROKEN)
