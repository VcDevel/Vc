...
Vc_NAMESPACE_BEGIN(Vc_IMPL_NAMESPACE)
    ...
    template<> struct StaticCastHelper<unsigned short, short         > { static __m512i cast(__m512i v) { return _mm512_and_ps(_mm512_castsi512_ps(v), _mm512_set1_epi32(0xffff)); } };
