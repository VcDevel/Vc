...
#define OP1(op) \
        static inline VectorType INTRINSIC Vc_CONST op(const VectorType a) { return CAT(_mm256_##op##_, SUFFIX)(a); }
#define OP(op) \
        static inline VectorType INTRINSIC Vc_CONST op(const VectorType a, const VectorType b) { return CAT(_mm256_##op##_ , SUFFIX)(a, b); }
#define OP_(op) \
        static inline VectorType INTRINSIC Vc_CONST op(const VectorType a, const VectorType b) { return CAT(_mm256_##op    , SUFFIX)(a, b); }
#define OPx(op, op2) \
        static inline VectorType INTRINSIC Vc_CONST op(const VectorType a, const VectorType b) { return CAT(_mm256_##op2##_, SUFFIX)(a, b); }
#define OPcmp(op) \
        static inline VectorType INTRINSIC Vc_CONST cmp##op(const VectorType a, const VectorType b) { return CAT(_mm256_cmp##op##_, SUFFIX)(a, b); }
#define OP_CAST_(op) \
        static inline VectorType INTRINSIC Vc_CONST op(const VectorType a, const VectorType b) { return CAT(_mm256_castps_, SUFFIX)( \
            _mm256_##op##ps(CAT(CAT(_mm256_cast, SUFFIX), _ps)(a), \
              CAT(CAT(_mm256_cast, SUFFIX), _ps)(b))); \
        }
#define MINMAX \
        static inline VectorType INTRINSIC Vc_CONST min(VectorType a, VectorType b) { return CAT(_mm256_min_, SUFFIX)(a, b); } \
        static inline VectorType INTRINSIC Vc_CONST max(VectorType a, VectorType b) { return CAT(_mm256_max_, SUFFIX)(a, b); }
...
#define SUFFIX si256
            ...
            static inline VectorType INTRINSIC Vc_CONST zero() { return CAT(_mm256_setzero_, SUFFIX)(); }
            static inline VectorType INTRINSIC Vc_CONST notMaskedToZero(VectorType a, _M256 mask) { return CAT(_mm256_and_, SUFFIX)(_mm256_castps_si256(mask), a); }
#undef SUFFIX
#define SUFFIX epi32
            static inline VectorType INTRINSIC Vc_CONST one() { return CAT(_mm256_setone_, SUFFIX)(); }

            static inline VectorType INTRINSIC Vc_CONST set(const int a) { return CAT(_mm256_set1_, SUFFIX)(a); }
            static inline VectorType INTRINSIC Vc_CONST set(const int a, const int b, const int c, const int d,
            ...
            MINMAX
            static inline EntryType INTRINSIC Vc_CONST min(VectorType a) {
            ...
            static inline EntryType INTRINSIC Vc_CONST max(VectorType a) {
            ...
            static inline EntryType INTRINSIC Vc_CONST add(VectorType a) {
            ...
            static inline EntryType INTRINSIC Vc_CONST mul(VectorType a) {
            ...
            static inline VectorType INTRINSIC Vc_CONST mul(VectorType a, VectorType b) { return _mm256_mullo_epi32(a, b); }

            OP(add) OP(sub)
            OPcmp(eq)
            OPcmp(lt)
            OPcmp(gt)
            static inline VectorType INTRINSIC Vc_CONST cmpneq(const VectorType a, const VectorType b) { _M256I x = cmpeq(a, b); return _mm256_andnot_si256(x, _mm256_setallone_si256()); }
            static inline VectorType INTRINSIC Vc_CONST cmpnlt(const VectorType a, const VectorType b) { _M256I x = cmplt(a, b); return _mm256_andnot_si256(x, _mm256_setallone_si256()); }
            static inline VectorType INTRINSIC Vc_CONST cmple (const VectorType a, const VectorType b) { _M256I x = cmpgt(a, b); return _mm256_andnot_si256(x, _mm256_setallone_si256()); }
            static inline VectorType INTRINSIC Vc_CONST cmpnle(const VectorType a, const VectorType b) { return cmpgt(a, b); }
#undef SUFFIX
            static inline VectorType INTRINSIC Vc_CONST round(VectorType a) { return a; }
        };
...
#define SUFFIX epi32
            ...
            static inline VectorType INTRINSIC Vc_CONST set(const unsigned int a) { return CAT(_mm256_set1_, SUFFIX)(a); }
            static inline VectorType INTRINSIC Vc_CONST set(const unsigned int a, const unsigned int b, const unsigned int c, const unsigned int d,
                    const unsigned int e, const unsigned int f, const unsigned int g, const unsigned int h) {
                return CAT(_mm256_set_, SUFFIX)(a, b, c, d, e, f, g, h); }

            OP(add) OP(sub)
            OPcmp(eq)
            static inline VectorType INTRINSIC Vc_CONST cmpneq(const VectorType a, const VectorType b) { return _mm256_andnot_si256(cmpeq(a, b), _mm256_setallone_si256()); }

#ifndef USE_INCORRECT_UNSIGNED_COMPARE
            static inline VectorType INTRINSIC Vc_CONST cmplt(const VectorType a, const VectorType b) {
                return _mm256_cmplt_epu32(a, b);
            }
            static inline VectorType INTRINSIC Vc_CONST cmpgt(const VectorType a, const VectorType b) {
            ...
            OPcmp(gt)
#endif
            static inline VectorType INTRINSIC Vc_CONST cmpnlt(const VectorType a, const VectorType b) { return _mm256_andnot_si256(cmplt(a, b), _mm256_setallone_si256()); }
            static inline VectorType INTRINSIC Vc_CONST cmple (const VectorType a, const VectorType b) { return _mm256_andnot_si256(cmpgt(a, b), _mm256_setallone_si256()); }
            static inline VectorType INTRINSIC Vc_CONST cmpnle(const VectorType a, const VectorType b) { return cmpgt(a, b); }
...
#undef SUFFIX
        ...
        template<> struct VectorHelper<signed short> {
            ...
            static inline VectorType INTRINSIC Vc_CONST or_(VectorType a, VectorType b) { return _mm_or_si128(a, b); }
            static inline VectorType INTRINSIC Vc_CONST and_(VectorType a, VectorType b) { return _mm_and_si128(a, b); }
            static inline VectorType INTRINSIC Vc_CONST xor_(VectorType a, VectorType b) { return _mm_xor_si128(a, b); }
            static inline VectorType INTRINSIC Vc_CONST zero() { return _mm_setzero_si128(); }
            static inline VectorType INTRINSIC Vc_CONST notMaskedToZero(VectorType a, __m128 mask) { return _mm_and_si128(_mm_castps_si128(mask), a); }

#define SUFFIX epi16
            static inline VectorType INTRINSIC Vc_CONST one() { return CAT(_mm_setone_, SUFFIX)(); }
            ...
            static inline VectorType INTRINSIC Vc_CONST set(const EntryType a) { return CAT(_mm_set1_, SUFFIX)(a); }
            static inline VectorType INTRINSIC Vc_CONST set(const EntryType a, const EntryType b, const EntryType c, const EntryType d,
            ...
            static inline VectorType INTRINSIC Vc_CONST abs(VectorType a) { return _mm_abs_epi16(a); }
            static inline VectorType INTRINSIC Vc_CONST mul(VectorType a, VectorType b) { return _mm_mullo_epi16(a, b); }
            static inline VectorType INTRINSIC Vc_CONST min(VectorType a, VectorType b) { return _mm_min_epi16(a, b); }
            static inline VectorType INTRINSIC Vc_CONST max(VectorType a, VectorType b) { return _mm_max_epi16(a, b); }
            ...
            static inline VectorType INTRINSIC Vc_CONST add(VectorType a, VectorType b) { return _mm_add_epi16(a, b); }
            static inline VectorType INTRINSIC Vc_CONST sub(VectorType a, VectorType b) { return _mm_sub_epi16(a, b); }
            static inline VectorType INTRINSIC Vc_CONST cmpeq(VectorType a, VectorType b) { return _mm_cmpeq_epi16(a, b); }
            static inline VectorType INTRINSIC Vc_CONST cmplt(VectorType a, VectorType b) { return _mm_cmplt_epi16(a, b); }
            static inline VectorType INTRINSIC Vc_CONST cmpgt(VectorType a, VectorType b) { return _mm_cmpgt_epi16(a, b); }
...
#undef SUFFIX
        ...
        template<> struct VectorHelper<unsigned short> {
            ...
            static inline VectorType INTRINSIC Vc_CONST zero() { return _mm_setzero_si128(); }
            static inline VectorType INTRINSIC Vc_CONST notMaskedToZero(VectorType a, __m128 mask) { return _mm_and_si128(_mm_castps_si128(mask), a); }
            static inline VectorType INTRINSIC Vc_CONST one() { return _mm_setone_epu16(); }

            static inline VectorType INTRINSIC Vc_CONST mul(VectorType a, VectorType b) { return _mm_mullo_epi16(a, b); }
            static inline VectorType INTRINSIC Vc_CONST min(VectorType a, VectorType b) { return _mm_min_epu16(a, b); }
            static inline VectorType INTRINSIC Vc_CONST max(VectorType a, VectorType b) { return _mm_max_epu16(a, b); }
...
#define SUFFIX epi16
            ...
            static inline VectorType INTRINSIC Vc_CONST set(const EntryType a) { return CAT(_mm_set1_, SUFFIX)(a); }
            static inline VectorType INTRINSIC Vc_CONST set(const EntryType a, const EntryType b, const EntryType c,
...
#ifndef USE_INCORRECT_UNSIGNED_COMPARE
            static inline VectorType INTRINSIC Vc_CONST cmplt(VectorType a, VectorType b) { return _mm_cmplt_epu16(a, b); }
            static inline VectorType INTRINSIC Vc_CONST cmpgt(VectorType a, VectorType b) { return _mm_cmpgt_epu16(a, b); }
#else
            static inline VectorType INTRINSIC Vc_CONST cmplt(VectorType a, VectorType b) { return _mm_cmplt_epi16(a, b); }
            static inline VectorType INTRINSIC Vc_CONST cmpgt(VectorType a, VectorType b) { return _mm_cmpgt_epi16(a, b); }
#endif
