...
template<> inline Vector<float> Vc_INTRINSIC PURE Vector<float>::operator/(const Vector<float> &x) const
{
...
template<> inline Vector<double> Vc_INTRINSIC PURE Vector<double>::operator/(const Vector<double> &x) const
{
