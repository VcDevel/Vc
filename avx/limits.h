...
namespace std
{
    ...
    template<> inline Vc::AVX::Vector<unsigned short> numeric_limits<Vc::AVX::Vector<unsigned short> >::max() throw() { return Vc::AVX::_mm256_setallone_si128(); }
    template<> inline Vc::AVX::Vector<unsigned short> numeric_limits<Vc::AVX::Vector<unsigned short> >::min() throw() { return _mm256_setzero_si128(); }
    template<> inline Vc::AVX::Vector<short> numeric_limits<Vc::AVX::Vector<short> >::max() throw() { return _mm256_srli_epi16(Vc::AVX::_mm256_setallone_si128(), 1); }
    template<> inline Vc::AVX::Vector<short> numeric_limits<Vc::AVX::Vector<short> >::min() throw() { return Vc::AVX::_mm256_setmin_epi16(); }

    template<> inline Vc::AVX::Vector<unsigned int> numeric_limits<Vc::AVX::Vector<unsigned int> >::max() throw() { return Vc::AVX::_mm256_setallone_si128(); }
    template<> inline Vc::AVX::Vector<unsigned int> numeric_limits<Vc::AVX::Vector<unsigned int> >::min() throw() { return _mm256_setzero_si128(); }
    template<> inline Vc::AVX::Vector<int> numeric_limits<Vc::AVX::Vector<int> >::max() throw() { return _mm256_srli_epi32(Vc::AVX::_mm256_setallone_si128(), 1); }
