...
////////////////////////////////////////////////////////////////////////////////////////////////////
//// stores
inline void VectorHelper<__m256>::store(float *mem, VTArg x, AlignedFlag)
{
    _mm256_store_ps(mem, x);
}
inline void VectorHelper<__m256>::store(float *mem, VTArg x, UnalignedFlag)
{
    _mm256_storeu_ps(mem, x);
}
inline void VectorHelper<__m256>::store(float *mem, VTArg x, StreamingAndAlignedFlag)
{
    _mm256_stream_ps(mem, x);
}
inline void VectorHelper<__m256>::store(float *mem, VTArg x, StreamingAndUnalignedFlag)
{
...
inline void VectorHelper<__m256>::store(float *mem, VTArg x, VTArg m, AlignedFlag)
{
    _mm256_maskstore(mem, m, x);
}
inline void VectorHelper<__m256>::store(float *mem, VTArg x, VTArg m, UnalignedFlag)
{
    _mm256_maskstore(mem, m, x);
}
inline void VectorHelper<__m256>::store(float *mem, VTArg x, VTArg m, StreamingAndAlignedFlag)
{
...
inline void VectorHelper<__m256>::store(float *mem, VTArg x, VTArg m, StreamingAndUnalignedFlag)
{
    _mm_maskmoveu_si128(avx_cast<__m128i>(x), avx_cast<__m128i>(m), reinterpret_cast<char *>(mem));
    _mm_maskmoveu_si128(_mm256_extractf128_si256(avx_cast<__m256i>(x), 1), _mm256_extractf128_si256(avx_cast<__m256i>(m), 1), reinterpret_cast<char *>(mem + 4));
}
...
////////////////////////////////////////////////////////////////////////////////////////////////////
//// stores
inline void VectorHelper<__m256d>::store(double *mem, VTArg x, AlignedFlag)
{
    _mm256_store_pd(mem, x);
}
inline void VectorHelper<__m256d>::store(double *mem, VTArg x, UnalignedFlag)
{
    _mm256_storeu_pd(mem, x);
}
inline void VectorHelper<__m256d>::store(double *mem, VTArg x, StreamingAndAlignedFlag)
{
    _mm256_stream_pd(mem, x);
}
inline void VectorHelper<__m256d>::store(double *mem, VTArg x, StreamingAndUnalignedFlag)
{
    _mm_maskmoveu_si128(avx_cast<__m128i>(x), _mm_setallone_si128(), reinterpret_cast<char *>(mem));
    _mm_maskmoveu_si128(avx_cast<__m128i>(_mm256_extractf128_pd(x, 1)), _mm_setallone_si128(), reinterpret_cast<char *>(mem + 2));
}
inline void VectorHelper<__m256d>::store(double *mem, VTArg x, VTArg m, AlignedFlag)
{
    _mm256_maskstore(mem, m, x);
}
inline void VectorHelper<__m256d>::store(double *mem, VTArg x, VTArg m, UnalignedFlag)
{
    _mm256_maskstore(mem, m, x);
}
inline void VectorHelper<__m256d>::store(double *mem, VTArg x, VTArg m, StreamingAndAlignedFlag)
{
    _mm_maskmoveu_si128(avx_cast<__m128i>(x), avx_cast<__m128i>(m), reinterpret_cast<char *>(mem));
...
inline void VectorHelper<__m256d>::store(double *mem, VTArg x, VTArg m, StreamingAndUnalignedFlag)
{
    _mm_maskmoveu_si128(avx_cast<__m128i>(x), avx_cast<__m128i>(m), reinterpret_cast<char *>(mem));
    _mm_maskmoveu_si128(avx_cast<__m128i>(_mm256_extractf128_pd(x, 1)), avx_cast<__m128i>(_mm256_extractf128_pd(m, 1)), reinterpret_cast<char *>(mem + 2));
}
...
////////////////////////////////////////////////////////////////////////////////////////////////////
//// stores
template<typename T> inline void VectorHelper<__m256i>::store(T *mem, VTArg x, AlignedFlag)
{
    _mm256_store_si256(reinterpret_cast<::__m256i *>(mem), x);
}
template<typename T> inline void VectorHelper<__m256i>::store(T *mem, VTArg x, UnalignedFlag)
{
    _mm256_storeu_si256(reinterpret_cast<::__m256i *>(mem), x);
}
template<typename T> inline void VectorHelper<__m256i>::store(T *mem, VTArg x, StreamingAndAlignedFlag)
{
    _mm256_stream_si256(reinterpret_cast<::__m256i *>(mem), x);
}
template<typename T> inline void VectorHelper<__m256i>::store(T *mem, VTArg x, StreamingAndUnalignedFlag)
{
    _mm_maskmoveu_si128(avx_cast<__m128i>(x), _mm_setallone_si128(), reinterpret_cast<char *>(mem));
    _mm_maskmoveu_si128(_mm256_extractf128_si256(x, 1), _mm_setallone_si128(), reinterpret_cast<char *>(mem + 4));
}
template<typename T> inline void VectorHelper<__m256i>::store(T *mem, VTArg x, VTArg m, AlignedFlag)
{
    _mm256_maskstore(mem, m, x);
}
template<typename T> inline void VectorHelper<__m256i>::store(T *mem, VTArg x, VTArg m, UnalignedFlag)
{
    _mm256_maskstore(mem, m, x);
}
template<typename T> inline void VectorHelper<__m256i>::store(T *mem, VTArg x, VTArg m, StreamingAndAlignedFlag)
{
...
template<typename T> inline void VectorHelper<__m256i>::store(T *mem, VTArg x, VTArg m, StreamingAndUnalignedFlag)
{
    _mm_maskmoveu_si128(lo128(x), lo128(m), reinterpret_cast<char *>(mem));
    _mm_maskmoveu_si128(hi128(x), hi128(m), reinterpret_cast<char *>(mem + 4));
}
...
////////////////////////////////////////////////////////////////////////////////////////////////////
//// stores
template<typename T> inline void VectorHelper<__m128i>::store(T *mem, VTArg x, AlignedFlag)
{
    _mm_store_si128(reinterpret_cast<::__m128i *>(mem), x);
}
template<typename T> inline void VectorHelper<__m128i>::store(T *mem, VTArg x, UnalignedFlag)
{
    _mm_storeu_si128(reinterpret_cast<::__m128i *>(mem), x);
}
template<typename T> inline void VectorHelper<__m128i>::store(T *mem, VTArg x, StreamingAndAlignedFlag)
{
    _mm_stream_si128(reinterpret_cast<::__m128i *>(mem), x);
}
template<typename T> inline void VectorHelper<__m128i>::store(T *mem, VTArg x, StreamingAndUnalignedFlag)
{
    _mm_maskmoveu_si128(x, _mm_setallone_si128(), reinterpret_cast<char *>(mem));
}
template<typename T> inline void VectorHelper<__m128i>::store(T *mem, VTArg x, VTArg m, AlignedFlag align)
{
    store(mem, _mm_blendv_epi8(load(mem, align), x, m), align);
}
template<typename T> inline void VectorHelper<__m128i>::store(T *mem, VTArg x, VTArg m, UnalignedFlag align)
{
    store(mem, _mm_blendv_epi8(load(mem, align), x, m), align);
}
template<typename T> inline void VectorHelper<__m128i>::store(T *mem, VTArg x, VTArg m, StreamingAndAlignedFlag)
{
    _mm_maskmoveu_si128(x, m, reinterpret_cast<char *>(mem));
}
template<typename T> inline void VectorHelper<__m128i>::store(T *mem, VTArg x, VTArg m, StreamingAndUnalignedFlag)
{
    _mm_maskmoveu_si128(x, m, reinterpret_cast<char *>(mem));
}
