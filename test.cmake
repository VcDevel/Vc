...
if(UNAME)
   ...
   find_program(VER ver)
   if(VER)
      execute_process(COMMAND ${VER} OUTPUT_VARIABLE arch OUTPUT_STRIP_TRAILING_WHITESPACE)
      string(REPLACE "Microsoft " "" arch "${arch}")
      string(REPLACE "[Version  " "" arch "${arch}")
...
elseif(arch MATCHES "mingw")
   if("$ENV{CXX}" MATCHES "g\\+\\+")
      execute_process(COMMAND "$ENV{CXX}" --version OUTPUT_VARIABLE COMPILER_VERSION ERROR_VARIABLE COMPILER_VERSION OUTPUT_STRIP_TRAILING_WHITESPACE)
...
if(WIN32 AND compiler STREQUAL "MSVC")
